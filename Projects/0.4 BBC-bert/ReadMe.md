...
No stopword removal or stemming (BERT-friendly preprocessing)
...
Fine-tuning approach (no training from scratch)
...
These images are included to make model behavior and performance easier to interpret.
...
While classical models perform strongly on this dataset, BERT provides superior contextual and semantic understanding, with better generalization potential.
...
More epochs do not necessarily improve performance
...
This project demonstrates a complete and well-structured transformer-based NLP workflow, covering data preparation, fine-tuning, evaluation, and interpretation.
It emphasizes correct methodology, not just performance metrics.